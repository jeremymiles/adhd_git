...
metafor::forest(dat_sens_plot$yi_plot, 
                ...
                header = "Study", main = "Sensitivity", cex = 0.6)

addpoly(res$beta[1], sei = res$se[1], row = -1, 
        transf = transf.ilogit, mlab = "Pooled Sensitivity", col = "red", cex = 0.6)
...
metafor::forest(dat_spec_plot$yi_plot, 
                ...
                header = "Study", main = "Specificity", cex = 0.6)

addpoly(res$beta[2], sei = res$se[2], row = -1, 
        transf = transf.ilogit, mlab = "Pooled Specificity", col = "red", cex = 0.6)
```
